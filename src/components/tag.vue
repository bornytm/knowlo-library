  		...
  		<div v-if="display==='thumb' ">
  			<span @mouseleave="leave()">
  				<div class="tagWidth">
                      ...
                      <q-tooltip :disable="!$q.showToolTips" :delay="500" :offset="[0, 0]" anchor="center left" self="center right">pin tag</q-tooltip>
  									</div>
  								</div>
  								<div  class="rotater">
                      ...
                      <q-tooltip :disable="!$q.showToolTips" :delay="500" :offset="[0, 0]" anchor="center left" self="center right">pin tag</q-tooltip>
                        ...
                        <q-tooltip :disable="!$q.showToolTips" :delay="500" :offset="[-15, 0]" anchor="center right" self="center left">tag page</q-tooltip>
  										</div>
  									</router-link>
  								</div>
  								<div class="rotater">
                      ...
                      <q-tooltip :disable="!$q.showToolTips" :delay="500" :offset="[0, 0]" anchor="center left" self="center right">remove tag</q-tooltip>
  									</div>
  								</div>
  								<!-- <div class="rotater">
                      ...
                      <q-tooltip :disable="!$q.showToolTips" :delay="500" :offset="[0, 0]" anchor="center left" self="center right">add tag</q-tooltip>
  									</div>
  								</div>
  								<div class="rotater">
  									<div @click="focus" class="mbtn mbtn-icon flexCenter"  :class="{showFocus: status.focusIcon, hide: hide.indexOf('focus')>-1 }">
  										<i class="fa fa-crosshairs"></i>
                      <q-tooltip :disable="!$q.showToolTips" :delay="500" :offset="[0, 0]" anchor="center left" self="center right">focus tag</q-tooltip>
  									</div>
  								</div>
