<template :member='member' >
    ...
    <li><router-link class="waves-effect" to="/test"><i class="fa fa-lg fa-compass"></i>Test</router-link></li>
    <li><router-link class="waves-effect" to="/explore"><i class="fa fa-lg fa-compass"></i>Explore</router-link></li>
    ...
    <li><a class="waves-effect" href="https://knowlo.org/principles"><i class="far fa-lg fa-lightbulb"></i>Principles</a></li>
    ...
    <li><a class="waves-effect" target="blank" href="http://github.com/MintyOrb/knowlo-library"><i class="fab fa-lg fa-github"></i>Code | Github</a></li>
	</ul>
</template>
<script>
